...
<div class="main-view">
    ...
    <div class="word-view">
        ...
        <?php else: ?>
           <div style="font-size:16px;margin-top:200px;" class="text-center">这个单词没有相似单词哦~</div><?php endif; ?>
    </div>
</div>
</div>
            ...
            series : [
                {
                    ...
                    data:[
                    <?php if(is_array($wordList)): foreach($wordList as $key=>$word): ?>{value:<?php echo ($word["freq"]); ?>, name:'<?php echo ($word["word"]); ?>'},<?php endforeach; endif; ?>
                    ],
                    itemStyle: {
                        emphasis: {
                            shadowBlur: 10,
